...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="mb-8 rounded-lg bg-white p-8 pb-12 shadow-lg">
      ...
      <div className="mt-8">
        <button type="button" className='transition duration-500 ease hover:bg-indigo-500 inline-block rounded-full bg-pink-600 ' onClick={handleCommentSubmission}>Post Comment</button>
      </div>
    </div>
  )
}
