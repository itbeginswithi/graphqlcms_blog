    ...
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
            <span className="transition te px-8 py-3 cursor-pointer duration-500 transform text-lg font-medium rounded-full hover:-translate-y-1 inline-block bg-pink-600">
                Continue Reading
            </span>
        </Link>
      </div>
