...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="mb-8 rounded-lg bg-white p-8 pb-12 shadow-lg">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4">
          <input type="text" ref={nameEl} className="w-full rounded-lg bg-gray-100 py-2 text-gray-700 outline-none focus:ring-2 focus:ring-gray-200"     placeholder="comment"
          name="comment"/>
      </div>
